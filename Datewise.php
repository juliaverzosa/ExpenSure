<?php 
    ...
    {
        header("Location:Datewise-Detailed.php");
    }
?>
        ...
        <div class="row">
            <div class="col-12 col-m-12 col-sm-12" >
                <div class="card">
                    ...
                    <form action="Datewise-Detailed.php" method="post" onsubmit = "return validate()" id="datewiseform">
